...
#---------------------------------------------------------------------------
def serial_paths(logfHndl,nopoints,stringpts,visited,EDthresholdans,nWeightPairs,xvalues,yvalues,pathadd,cdmatrix,paths,edge_type,edge_dist,trans_func,const_kernal_vol,vol_constant =None,nbhd_dist=None,resans=None):
	'''
	...
	for i in range(len(srclist)): 
		...
		if edge_type == 'normal':
			if resans: # Use resistance LCP
				path, vOrder,pathlens =Dijkstra(nWeightPairs,xvalues,\
